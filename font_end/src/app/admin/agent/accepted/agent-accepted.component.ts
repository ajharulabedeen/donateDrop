...
@Component({
  selector: 'app-agent-accepted',
  templateUrl: './agent-accepted.component.html',
  styleUrls: ['./agent-accepted.component.scss']
})
export class AgentAcceptedComponent implements OnInit {
