...
public class RequestSearchDonnerAssing {
    private int max;
    private int start;
    private String key;
    ...
    public RequestSearchDonnerAssing() {
    }

    public RequestSearchDonnerAssing(int start, int max, String column, String key, String statusType) {
        this.start = start;
        this.max = max;
        this.column = column;
        this.key = key;
